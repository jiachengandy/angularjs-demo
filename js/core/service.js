define([ 'baseModule' ], function()
{
	...
	angular.module("monitor.core").factory('monitorGet', function(monitorAjax)
	{
	...
	angular.module("monitor.core").factory('monitorPost', function(monitorAjax)
	{
		return function(option)
		{
			option = $.extend(
	...
	angular.module("monitor.core").factory('monitorI18n',["$rootScope", function($rootScope,$scope)
	{
	...
	angular.module("monitor.core").factory('monitorAjax', function($http, $location, $rootScope)
	{
		var coverQ = [];
		function showCover()
		{
		...
		function process(option)
		{
			var defaultAjax =
			{
				...
				url : $rootScope.$webapp + "/restlet/" + option.url,
			...
			option.processData && (defaultAjax["processData"] = option.processData);
			return defaultAjax;
		}
	...
	angular.module("monitor.core").factory('position', function()
	{
		var position =
		{
			margin : function(id)
	...
	var popupwinArra = [];
	angular.module("monitor.core").factory('popup',
...
//						$location.url(src);
	...
	angular.module("monitor").factory('messageBox', [ 'popup', '$rootScope', function(popup, $rootScope)
	{
		var src = "/js/directive/html/messageBox.html";
		var messageBox =
		{
